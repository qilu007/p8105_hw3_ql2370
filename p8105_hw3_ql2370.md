...
#sheet_data = mutate(sheet_data, week_weekends = ifelse(day =="Saturday" | day == "Sunday", 1, 0))

sheet_data$week_or_not <- sheet_data$week
```

pols\_month= mutate(pols\_month, president = replace(president,
prez\_gop == “1”,“gop”), president = replace(president, prez\_gop ==
“2”,“gop”), president = replace(president, prez\_dem == “1”,“dem”),
president = replace(president, prez\_dem == “2”,“dem”),)

within(df, df$d \<- ifelse(a\<5, a, ifelse(a==5, 0, ifelse(a==6,b,NA)))
)
